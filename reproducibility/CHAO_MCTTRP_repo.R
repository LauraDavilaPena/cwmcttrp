...
result[[3]] <- CW_algorithm("instances/CHAO_MCTTRP_03.txt", "MCTTRP", 8, 5, 0) # 1

result[[4]] <- CW_algorithm("instances/CHAO_MCTTRP_04.txt", "MCTTRP", 13, 8, 0)
...
result[[9]] <- CW_algorithm("instances/CHAO_MCTTRP_09.txt", "MCTTRP", 11, 7, 0) 
...
result[[13]] <- CW_algorithm("instances/CHAO_MCTTRP_13.txt", "MCTTRP", 24, 14, 0)
result[[14]] <- CW_algorithm("instances/CHAO_MCTTRP_14.txt", "MCTTRP", 26, 14, 0)
result[[15]] <- CW_algorithm("instances/CHAO_MCTTRP_15.txt", "MCTTRP", 25, 13, 0) 
...
result[[18]] <- CW_algorithm("instances/CHAO_MCTTRP_18.txt", "MCTTRP", 11, 6, 0) # x

result[[19]] <- CW_algorithm("instances/CHAO_MCTTRP_19.txt", "MCTTRP", 13, 8, 0)
result[[20]] <- CW_algorithm("instances/CHAO_MCTTRP_20.txt", "MCTTRP", 13, 8, 0)
result[[21]] <- CW_algorithm("instances/CHAO_MCTTRP_21.txt", "MCTTRP", 13, 8, 0)
...
result[[6]] <- MCTTRP_opt_solver("instances/CHAO_MCTTRP_06.txt", "MCTTRP", 14, 8, total_time=60, total_iterations=2, verbose=0) 
