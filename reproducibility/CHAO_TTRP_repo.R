...
result <- list()
result[[1]] <- MCTTRP_opt_solver("instances/CHAO_TTRP_01.txt", "TTRP", 5, 3, total_time=3600, total_iterations=30, verbose=0)
...
result[[7]] <- MCTTRP_opt_solver("instances/CHAO_TTRP_07.txt", "TTRP", 8, 4, total_time=3600, total_iterations=30, verbose=0)
result[[8]] <- MCTTRP_opt_solver("instances/CHAO_TTRP_08.txt", "TTRP", 8, 4,  total_time=3600, total_iterations=30, verbose=0)
result[[9]] <- MCTTRP_opt_solver("instances/CHAO_TTRP_09.txt", "TTRP", 8, 4,  total_time=3600, total_iterations=30, verbose=0)
