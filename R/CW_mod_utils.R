...
insert_hoppers_MCTTRP_CVR<-function(route_i, routes_res, input) {
...
insert_hoppers_MCTTRP_PTR<-function(route_i, routes_res, input) {
...
insert_hoppers_MCTTRP_PVR<-function(route_i, routes_res, input) {
